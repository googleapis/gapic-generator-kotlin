...
internal class ClientPluginTest {
    ...
    private fun verifyResponse(response: PluginProtos.CodeGeneratorResponse) {
        ...
        val clientBase = response.fileList.first { it.name == "google/example/AbstractSimpleServiceClient.kt" }.content
    ...
    private fun verifyResponse(directory: File) {
        ...
        val clientBase = files.first { it.path.endsWith("google/example/AbstractSimpleServiceClient.kt") }.readText()
    ...
    private fun verifyResponse(client: String, clientBase: String, builders: String) {
        ...
        assertThat(clientBase).contains("abstract class AbstractSimpleServiceClient")
